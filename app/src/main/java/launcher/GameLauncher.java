...
//         switch (item) {
//             case ITEM_MODE -> launchBoard(true);   // 아이템 모드
//             case START -> launchBoard(false);      // 일반 모드
...
//     private void launchBoard(boolean itemMode) {
//         frame.setVisible(false);

//         Board game = new Board();
//         game.setTitle(itemMode ? "TETRIS – Item Mode" : "TETRIS – Normal Mode");
//         game.setLocationRelativeTo(null);
//         game.setVisible(true);

//         // 🔹 아이템 모드 활성화
//         if (itemMode && game.getLogic() != null) {
